...
// function createScript(url){//创建script标签
...
// function createLink(href){//创建link标签
...
module.exports = function(content,file,conf){
    ...
    var arrMactches_css,
        ...
        load_html = '<div id="Nie_load_id" style="position:absolute;z-index:9999;left:0;top:0;width:100%;height:100%;background:#000;overflow:hidden;margin:0;padding:0;">'+
            '<svg xmlns="http://www.w3.org/2000/svg" id="Nie_loadBg_id" style="position:absolute;width:165px;height:130px;left:50%;top:50%;margin-left:-82px;margin-top:-75px;">' +
                 ...
                 '</g>' +
                '</svg>'+
                '<svg xmlns="http://www.w3.org/2000/svg" id="Nie_loadTop_id" style="position:absolute;width:165px;height:0;left:50%;top:50%;margin-left:-82px;margin-top:-75px;">' +
                 '<g>' +
    ...
    if(file.isHtmlLike){
        ...
        if(arrMactches_css){
            ...
            // {
            //     console.log('css'+i+':'+arrMactches_css[i]);   //Cat  cat
            //     // requreHtml_css +="document.write('"+ arrMactches_css[0] +"');";
            // }
        ...
        // function scriptHtml(){
            ...
            if(arrMactches_css){
                for (var i=0;i < arrMactches_css.length ; i++){
                    ...
                    // html += 'document.body.appendChild('+createLink(href)+')';
                }
            }

            // if(arrMactches_js){
            //     for (var i=0;i < arrMactches_js.length ; i++){
            //         var href = arrMactches_js[i].match(csshrefReg);
            //         html += document.body.appendChild(createLink(href));
            //     }
        ...
        //     html += document.body.appendChild(createScript());
        //     html += document.body.appendChild(createLink());
        ...
        // console.log(arrMactches_body);
        
        // if(arrMactches_body){
            // for (var i=0;i < arrMactches_body.length ; i++)
            // {
            //     console.log('js'+i+':'+arrMactches_body[i]);   //Cat  cat
            // }
